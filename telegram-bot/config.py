...
IMAGE_COST = 50
IMAGE_COST_M2 = 100  # gpt-image-2 费用更贵
RECHARGE_RATE = 100
NEW_USER_BONUS = 50
DEFAULT_IMAGE_MODEL = "gpt-image-2"  # 默认用 gpt-image-2
IMAGE_MODELS = {
    "gpt-image-2": {"name": "GPT Image 2", "cost": IMAGE_COST_M2, "quality": "standard"},
...
WELCOME_ZH = """🎨 **AI 生图** — 发送「用 Image 2 帮我画一个图」+ 你的描述，我会用 GPT Image 2 生成高质量图片
...
**计费说明：**
• 1 USDT = 100 积分
• 生图费用：GPT Image 2 = 100 积分/张，GPT Image 1 = 50 积分/张
• 新用户首次使用赠送 50 积分
...
WELCOME_EN = """🎨 **AI Image Generation** — Send 「Use Image 2 to draw」+ your description, I'll generate high-quality images with GPT Image 2
...
**Pricing:**
• 1 USDT = 100 credits
• GPT Image 2 = 100 credits/image, GPT Image 1 = 50 credits/image
...
WELCOME_RU = """🎨 **AI Генерация изображений** — Отправьте «Используй Image 2 для рисования» + ваше описание, я создам качественные изображения с GPT Image 2
...
**Цены:**
• 1 USDT = 100 кредитов
• GPT Image 2 = 100 кредитов/изображение, GPT Image 1 = 50 кредитов/изображение
